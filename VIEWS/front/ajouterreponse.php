            ...
            <div class="row justify-content-center">
              ...
              <div class="col-lg-8">
                <div class="contact-wrap">
                  <h3 class="mb-4 text-center">Reponse de la reclamation</h3>
                  ...
                  <form class="clearfix" action="" method="POST" id="comment_form">
                    ...
                    <input type="texte" name="id_reclamation" value="<?php echo $_GET['id']; ?>">

                    <label for="contenu">Id D'utilisateur
                    </label>
                    <input class="form-control" type="text" name="texte" maxlength="20">
