...
<form>
                            ...
                            <div class="form-group">
                              ...
                              <input value="<?PHP echo $uname ?>" class="form-control" name="uname" placeholder=" uname" rows="10" type="text"></textarea>
                            </div>
                            <div class="form-group">
                              <label>email</label>
                            ...
                            <div class="form-group">
                              ...
                              <input value="<?PHP echo $pswd ?>" class="form-control" name="pswd" placeholder="pswd" rows="10" type="text"></textarea>
                            </div>
                            <div class="form-group">
                              <label>dateN</label>
