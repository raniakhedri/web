...
<!-- Centered Modal -->
<div id='centeredModal' class="modal-wrapper modal-is-open">
...
echo $row['email'] . "<br>";
echo $row['tel'] . "<br>";
echo $row['name_account'] . "<br>";
echo $row['event'] . "<br>";
 
                      ?>
<a href="win.php?id=<?=$row['id']?>"><h3 style="color: red;">Prize!</h3></a>
<a href="mail.php?id=<?=$row['id']?>"><h3 style="color: red;">mail!</h3></a>
<a href="confirmation.php?id=<?=$row['id']?>"><h3 style="color: red;">confirmer!</h3></a>
                </p>
...
if(isset($_POST['button'])){
    ...
    ?>
            <form action="" methode="POST"  class="w-full" >
                ...
                <div class="mt-5">
                     <input type="submit" value="Modifier" name="button" class='btn btn-primary bg-green-500 hover:bg-green-800 text-white font-bold py-2 px-4 rounded'>
                    <button type="submit" name="button" class='btn btn-primary bg-green-500 hover:bg-green-800 text-white font-bold py-2 px-4 rounded'> Submit
                    </button>
