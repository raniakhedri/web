...
<div class="content delete">
	<h2>Delete pub #<?=$pub['id']?></h2>
    <?php if ($msg): ?>
    <p><?=$msg?></p>
    <?php else: ?>
	<p>Are you sure you want to delete pub #<?=$pub['id']?>?</p>
    <div class="yesno">
        <a href="delete.php?id=<?=$pub['id']?>&confirm=yes">Yes</a>
        <a href="delete.php?id=<?=$pub['id']?>&confirm=no">No</a>
    </div>
    <?php endif; ?>
</div>
