...
session_start();
	...
	$listeAdherents=$adherentC->afficheradherentspending($userid); 
?>
<html>
<head>
        <meta charset="utf-8">
...
<link href="assets/css/vendor/responsive.bootstrap5.css" rel="stylesheet" type="text/css" />
	...
	<body class="loading" data-layout-config='{"leftSideBarTheme":"dark","layoutBoxed":false, "leftSidebarCondensed":false, "leftSidebarScrollable":false,"darkMode":false, "showRightSidebarOnStart": true}'>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Nos evenements</h4>
                                </div>
                            </div>
                        </div>
	    
		<center><h1>Liste des evenements en attente</h1></center>
		...
		<thead>
			...
			<?php
				foreach($listeAdherents as $evenement){
			?>
			<tr>
                ...
                <td><?php echo $evenement['genre']; ?></td>
				...
				<td>
					<a href="supprimeradherent.php?id=<?php echo $evenement['id']; ?>">Supprimer</a>
				</td>
			</tr>
			<?php
				}
