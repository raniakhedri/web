    ...
    <div class="container1">
      ...
      <div class="row justify-content-center">
        ...
        <form action="" method="POST">
                   ...
                   <input type="text" name="texte" id="contenu" value="<?php echo $reponse['texte']; ?>" maxlength="20">
                <input type="hidden" name="id_reclamation" id="idpost" value="<?php echo $reponse['id_reclamation']; ?>" maxlength="20">
